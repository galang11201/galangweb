...
// Variables
const rootDomain = "galangworker.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "galang"; // Ganti dengan nama workers kalian
const apiKey = ""; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "galangworker@gmail.com"; // Ganti dengan email yang kalian gunakan
